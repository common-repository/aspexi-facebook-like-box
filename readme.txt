...
= 2.1.17 =
* Deprecated data-show-posts
* Add browser's lazy-loading mechanism
* Facebook API update

= 2.1.16 =
* Plugin's updates to match Facebook Developer Submission Guidelines
* Facebook API update

= 2.1.15 =
* (premium) Lifetime license 'expiry' info now showing correctly.
* Plugin's name update to match Facebook Developer Submission Guidelines
* Facebook API update
* jQuery Migrate related issue fix

= 2.1.14 =
* (premium) Better License status notification in Settings page
* Facebook API update
* Plugin's name update to match Facebook Developer Submission Guidelines

= 2.1.13 =
* Android close with click fix
* Facebook API update
